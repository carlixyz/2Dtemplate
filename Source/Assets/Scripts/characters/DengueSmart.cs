            ...
            switch (currentState)
            {
                ...
                case EnemyState.Roaming:
                    ...
                    if (distanceToTarget <= searchRange)		            // SI distancia al objetivo es menor que el rango de busqueda..
                        if (distanceToTarget <= attackRange  && thisTransform.position.y >= playerTransform.position.y + 1)	                    // si est� dentro de rango de ataque..
                    ...
                    else									                        // SINO chequear rutina habitual de comportamiento cuando est� solo...
                        GoHome();						                            // Volver a casa! ( cambia direcci�n de lado y avanzar indefinidamente.. 
                    break;
				...
				thisTransform.Rotate(Vector3.forward, -orientation * 45 * Time.deltaTime);
